...
```bash
curl -O https://raw.githubusercontent.com/aeternity/aeternity/v2.0.0-rc.1/scripts/install.sh && chmod +x install.sh && ./install.sh 2.0.0-rc.1
```
...
cd ~/aeternity/node
tar xf ~/Downloads/aeternity-2.0.0-rc.1-macos-x86_64.tar.gz
```
