...
```bash
curl -O https://raw.githubusercontent.com/aeternity/installer/v1.0.0/install.sh && chmod +x install.sh && ./install.sh 2.3.0
```
...
cd ~/aeternity/node
tar xf ~/Downloads/aeternity-2.3.0-macos-x86_64.tar.gz
```
