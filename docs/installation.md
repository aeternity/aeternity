...
```bash
curl -O https://raw.githubusercontent.com/aeternity/aeternity/v1.5.0/scripts/install.sh && chmod +x install.sh && ./install.sh 1.5.0
```
...
cd ~/aeternity/node
tar xf ~/Downloads/aeternity-1.5.0-macos-x86_64.tar.gz
```
