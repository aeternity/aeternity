...
```bash
curl -O https://raw.githubusercontent.com/aeternity/aeternity/v1.4.0/scripts/install.sh && chmod +x install.sh && ./install.sh 1.4.0
```
...
cd ~/aeternity/node
tar xf ~/Downloads/aeternity-1.4.0-macos-x86_64.tar.gz
```
