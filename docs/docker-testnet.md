...
To persist blockchain data and node keys between container runs, use [Docker volumes](https://docs.docker.com/engine/admin/volumes/volumes/). Replace `~/.aeternity/data` with location of your choice.


```bash
docker run -d -p 3013:3013 \
    -v ~/.aeternity/data:/home/epoch/node/data \
