...
[This][this-release] is a bugfix release.
It contains:
* Fix build of Windows package
  * to include the new minerva accounts file
  * to use proper data directory

[this-release]: https://github.com/aeternity/aeternity/releases/tag/v2.0.1

This release is backward compatible with `v2.0.0`.
...
[docker]: https://github.com/aeternity/aeternity/blob/v2.0.1/docs/docker.md
[build]: https://github.com/aeternity/aeternity/blob/v2.0.1/docs/build.md
...
[swagger-yaml]: https://github.com/aeternity/aeternity/blob/v2.0.1/config/swagger.yaml
[swagger-ui]: https://aeternity.github.io/api-docs/?config=https://raw.githubusercontent.com/aeternity/aeternity/v2.0.1/apps/aehttp/priv/swagger.json
[api-doc]: https://github.com/aeternity/protocol/blob/aeternity-node-v2.0.1/node/api/README.md
