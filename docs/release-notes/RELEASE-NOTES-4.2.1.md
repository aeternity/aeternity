...
* Improves State Channels tests to cover `Call.origin` and `Call.caller`
...
[docker]: https://github.com/aeternity/aeternity/blob/v4.2.1/docs/docker.md
[build]: https://github.com/aeternity/aeternity/blob/v4.2.1/docs/build.md
...
[swagger-yaml]: https://github.com/aeternity/aeternity/blob/v4.2.1/config/swagger.yaml
[swagger-ui]: https://aeternity.github.io/api-docs/?config=https://raw.githubusercontent.com/aeternity/aeternity/v4.2.1/apps/aehttp/priv/swagger.json
