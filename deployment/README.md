...
```bash
ansible-playbook --extra-vars "package=/path/to/epoch-0.11.1.tar.gz" deploy.yml
```
...
```bash
PACKAGE="https://github.com/aeternity/epoch/releases/download/v0.11.1/epoch-0.11.1-ubuntu.tar.gz"
