...
```bash
ansible-playbook --extra-vars "package=/path/to/epoch-0.18.0.tar.gz" deploy.yml
```
...
```bash
PACKAGE="https://github.com/aeternity/epoch/releases/download/v0.18.0/epoch-0.18.0-ubuntu-x86_64.tar.gz"
