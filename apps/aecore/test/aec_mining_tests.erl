        ...
        {"Find a new block",
         fun() ->
                 ...
                 Nonce = case aec_hard_forks:protocol_effective_at_height(Height + 1) of
                             ...
                             ?MINERVA_PROTOCOL_VSN -> 8653900455172602025;
                             ?FORTUNA_PROTOCOL_VSN -> 12969173499992730763;
                             ?LIMA_PROTOCOL_VSN    -> 12849019366043967807;
                             ?IRIS_PROTOCOL_VSN    -> 12072919756504300779 
                         end,
