...
generic_accounts_test_() ->
    generic_accounts(100, 100).

generic_accounts_override_test_() ->
    %% Test the hard coded accounts are overridden
    generic_accounts(?ROMA_PROTOCOL_VSN, 0).


generic_accounts(Protocol, Height) ->
    Dir = ?ROOT_DIR ++ "/.generic",
