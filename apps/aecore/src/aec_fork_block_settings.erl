...
accounts_file_name(Release) ->
    % check if: in devmode, a custom DB dir is defined & that dir cointains a custom accounts json (generated by devmode)
    case aecore_env:is_dev_mode() and is_list(os:getenv("AE__CHAIN__DB_PATH")) andalso is_devmode_accounts_present() of
        false ->
            io:fwrite("---------->>> No accounts file found, reading default accounts json"),
...
is_devmode_accounts_present() ->
    ...
    case filelib:is_regular(FilePath) of
        ...
        false ->  io:fwrite("---------->>> NO file found at: ~p ~n", [FilePath]), false        
    end.
