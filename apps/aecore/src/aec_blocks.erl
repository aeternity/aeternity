...
validate_key_block(#key_block{} = Block, Version) ->
    case aec_headers:validate_key_block_header(to_key_header(Block), Version) of
        ok -> ok;
...
validate_micro_block(#mic_block{} = Block, Version) ->
    Validators = [fun validate_txs_hash/1,
                  fun validate_gas_limit/1,
                  fun validate_txs_fee/1,
                  fun validate_pof/1
                 ],
    case aec_headers:validate_micro_block_header(to_micro_header(Block), Version) of
        ok ->
