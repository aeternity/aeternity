...
%% Only for aecore_app and the aecore.app.src setup hook
-export([ensure_env/0,
...
%% Not exported outside TEST, and not to be: a caller that resolved directly
%% would silently disagree with every signature check.
