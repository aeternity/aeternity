...
swagger_name_to_type(<<"OracleRegisterTxInput">>)      -> oracle_register_tx;
swagger_name_to_type(<<"OracleExtendTx">>)             -> oracle_extend_tx;
swagger_name_to_type(<<"OracleExtendTxInput">>)        -> oracle_extend_tx;
swagger_name_to_type(<<"OracleQueryTx">>)              -> oracle_query_tx;
swagger_name_to_type(<<"OracleQueryTxInput">>)         -> oracle_query_tx;
swagger_name_to_type(<<"OracleRespondTx">>)            -> oracle_response_tx;
swagger_name_to_type(<<"OracleRespondTxInput">>)       -> oracle_response_tx;
swagger_name_to_type(<<"NamePreclaimTx">>)             -> name_preclaim_tx;
swagger_name_to_type(<<"NamePreclaimTxInput">>)        -> name_preclaim_tx;
swagger_name_to_type(<<"NameClaimTx">>)                -> name_claim_tx;
swagger_name_to_type(<<"NameClaimTxInput">>)           -> name_claim_tx;
swagger_name_to_type(<<"NameTransferTx">>)             -> name_transfer_tx;
swagger_name_to_type(<<"NameTransferTxInput">>)        -> name_transfer_tx;
swagger_name_to_type(<<"NameUpdateTx">>)               -> name_update_tx;
swagger_name_to_type(<<"NameUpdateTxInput">>)          -> name_update_tx;
swagger_name_to_type(<<"NameRevokeTx">>)               -> name_revoke_tx;
swagger_name_to_type(<<"NameRevokeTxInput">>)          -> name_revoke_tx;
swagger_name_to_type(<<"ContractCallTx">>)             -> contract_call_tx;
swagger_name_to_type(<<"ContractCallTxInput">>)        -> contract_call_tx;
swagger_name_to_type(<<"ContractCreateTx">>)           -> contract_create_tx;
swagger_name_to_type(<<"ContractCreateTxInput">>)      -> contract_create_tx;
...
swagger_name_to_type(<<"ChannelCreateTxInput">>)       -> channel_create_tx;
...
swagger_name_to_type(<<"ChannelCloseSoloTxInput">>)    -> channel_close_solo_tx;
swagger_name_to_type(<<"ChannelCloseMutualTx">>)       -> channel_close_mutual_tx;
swagger_name_to_type(<<"ChannelSlashTx">>)             -> channel_slash_tx;
swagger_name_to_type(<<"ChannelSlashTxInput">>)        -> channel_slash_tx;
...
swagger_name_to_type(<<"ChannelSnapshotSoloTxInput">>) -> channel_snapshot_solo_tx;
swagger_name_to_type(<<"ChannelSetDelegatesTx">>)      -> channel_set_delegates_tx;
swagger_name_to_type(<<"ChannelSetDelegatesTxInput">>) -> channel_set_delegates_tx;
%% not exposed in HTTP API:
