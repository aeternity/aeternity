...
opcode(?SSTORE)         -> {'SSTORE'         ,  2,  0, 0}; %% TODO
...
opcode(?CALL)           -> {'CALL'           ,  7,  1, 40}; %% TODO
opcode(?CALLCODE)       -> {'CALLCODE'       ,  7,  1, 40}; %% TODO
opcode(?RETURN)         -> {'RETURN'         ,  2,  0, ?GZERO};
opcode(?DELEGATECALL)   -> {'DELEGATECALL'   ,  6,  1, 40}; %% TODO
