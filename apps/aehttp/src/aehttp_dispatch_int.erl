...
tx_swagger_name_from_operation_id('PostContractCreate') -> 'ContractCreateTxInput';
tx_swagger_name_from_operation_id('PostContractCall') -> 'ContractCallTxInput';
tx_swagger_name_from_operation_id('PostNamePreclaim') -> 'NamePreclaimTxInput';
tx_swagger_name_from_operation_id('PostNameUpdate') -> 'NameUpdateTxInput';
tx_swagger_name_from_operation_id('PostNameClaim') -> 'NameClaimTxInput';
tx_swagger_name_from_operation_id('PostNameTransfer') -> 'NameTransferTxInput';
tx_swagger_name_from_operation_id('PostNameRevoke') -> 'NameRevokeTxInput';
tx_swagger_name_from_operation_id('PostChannelCreate') -> 'ChannelCreateTxInput';
...
tx_swagger_name_from_operation_id('PostChannelSnapshotSolo') -> 'ChannelSnapshotSoloTxInput';
tx_swagger_name_from_operation_id('PostChannelSetDelegates') -> 'ChannelSetDelegatesTxInput';
tx_swagger_name_from_operation_id('PostChannelCloseMutual') -> 'ChannelCloseMutualTx';
tx_swagger_name_from_operation_id('PostChannelCloseSolo') -> 'ChannelCloseSoloTxInput';
tx_swagger_name_from_operation_id('PostChannelSlash') -> 'ChannelSlashTxInput';
tx_swagger_name_from_operation_id('PostChannelSettle') -> 'ChannelSettleTx';
tx_swagger_name_from_operation_id('PostOracleRegister') -> 'OracleRegisterTxInput';
tx_swagger_name_from_operation_id('PostOracleExtend') -> 'OracleExtendTxInput';
tx_swagger_name_from_operation_id('PostOracleQuery') -> 'OracleQueryTxInput';
tx_swagger_name_from_operation_id('PostOracleRespond') -> 'OracleRespondTxInput'.
