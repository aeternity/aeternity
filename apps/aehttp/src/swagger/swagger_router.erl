...
get_operations() ->
    #{ 
        ...
        'GetPubKey' => #{
            path => "/v2/account/pub-key",
            method => <<"GET">>,
            handler => 'swagger_node_operator_handler'
        },
        'GetActiveRegisteredOracles' => #{
            path => "/v2/oracles",
            method => <<"GET">>,
            handler => 'swagger_obsolete_handler'
        },
        'GetOracleQuestions' => #{
            path => "/v2/oracle-questions",
            method => <<"GET">>,
        ...
        'GetAccountTransactions' => #{
            path => "/v2/account/txs/:account_pubkey",
            method => <<"GET">>,
            handler => 'swagger_transactions_handler'
        },
        'GetTx' => #{
            path => "/v2/tx/:tx_hash",
            method => <<"GET">>,
