...
block_pack(Config) ->
    ...
    {ok, 200, #{<<"tx_hash">> := SpendTxHash1}} = post_tx(SpendTx1),
    {ok, 200, #{<<"tx_hash">> := SpendTxHash2a}} = post_tx(SpendTx2a),
    {ok, 200, #{<<"tx_hash">> := SpendTxHash2b}} = post_tx(SpendTx2b),
    ct:log("SpendTxHash1 = ~p", [SpendTxHash1]),
    ct:log("SpendTxHash2a = ~p", [SpendTxHash2a]),
    ct:log("SpendTxHash2b = ~p", [SpendTxHash2b]),
    ...
    {ok, 200, #{<<"tx_hash">> := SpendTxHash4b}} = post_tx(SpendTx4b),
    ct:log("SpendTxHash3 = ~p", [SpendTxHash3]),
    ct:log("SpendTxHash4a = ~p", [SpendTxHash4a]),
    ct:log("SpendTxHash4b = ~p", [SpendTxHash4b]),
