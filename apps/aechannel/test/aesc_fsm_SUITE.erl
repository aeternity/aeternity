...
mine_blocks(Node, N, _) ->
    aecore_suite_utils:mine_key_blocks(aecore_suite_utils:node_name(Node), N, #{strictly_follow_top => true}).
...
prep_initiator(Node) ->
    ...
    aecore_suite_utils:mine_key_blocks(aecore_suite_utils:node_name(Node), 30, #{strictly_follow_top => true}),
