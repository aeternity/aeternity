...
-export([
    ...
    test_compat_with_initiator_node_using_fortuna_initial_channel_version/1,
    test_compat_with_responder_node_using_fortuna_initial_channel_version/1,
...
all() -> [
    ...
    test_compat_with_initiator_node_using_fortuna_initial_channel_version,
    test_compat_with_responder_node_using_fortuna_initial_channel_version,
...
test_compat_with_initiator_node_using_fortuna_initial_channel_version(Cfg) ->
    test_different_nodes_channel_(set_genesis_accounts(node_base_spec_with_fortuna_initial_channel_version()),
                                  set_genesis_accounts(#{}), Cfg).

test_compat_with_responder_node_using_fortuna_initial_channel_version(Cfg) ->
    test_different_nodes_channel_(set_genesis_accounts(#{}),
                                  set_genesis_accounts(node_base_spec_with_fortuna_initial_channel_version()), Cfg).
...
node_base_spec_with_fortuna_initial_channel_version() ->
    #{source => {pull, "aeternity/aeternity:v3.0.1"}}.
